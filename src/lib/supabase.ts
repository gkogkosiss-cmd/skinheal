...
const CLOUD_URL = "https://obevadiyhuvipyzkcoit.supabase.co";
const CLOUD_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9iZXZhZGl5aHV2aXB5emtjb2l0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI3MDc3OTUsImV4cCI6MjA4ODI4Mzc5NX0.SSpIad0LF7nd4b3O1K_sAYYDvju7HOmdR48iP_bSx6k";
...
export const EDGE_FUNCTIONS_URL = `${CLOUD_URL}/functions/v1`;
export const EDGE_FUNCTIONS_KEY = CLOUD_ANON_KEY;
